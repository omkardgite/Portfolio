...
import { FaDownload, FaUsers, FaCalendarAlt } from "react-icons/fa";
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        {activeTab === "about" && (
          ...
          >
            <motion.div
              className="space-y-6 justify-items-center flex flex-col items-center text-justify"
            ...
            >
              <p data-testid="about-bio-1" className="text-lg leading-relaxed">
                ...
                responsive, scalable, and user-focused web applications. What
                started as a curiosity for how digital experiences are crafted
                grew into a passion for creating clean, accessible, and
                high-performing UIs. Over the years, I’ve specialized in modern
                JavaScript, React, Next.js while continuously exploring new
                tools and best practices to deliver impactful products.
              </p>
